      ...
      <div className="grid md:grid-cols-12 gap-12 items-start">
        <div className="md:col-span-4">
           ...
           <div className="text-slate-400 space-y-4">
             ...
             <p>
               Colleagues know me as someone who listens first, gives honest advice, and thrives on solving complex challenges.
             </p>
           </div>
        </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {AWARDS.map((award, idx) => {
                ...
                if (award.color === 'platinum') {
                  ...
                  bgGradient = "bg-gradient-to-br from-slate-800/50 to-slate-900 hover:from-slate-700/50 hover:to-slate-800";
                  icon = <Trophy className="w-6 h-6" />;
                } else if (award.color === 'gold') {
                  accentColor = "text-yellow-500";
                  borderColor = "hover:border-yellow-500/50";
                  bgGradient = "bg-gradient-to-br from-slate-900 to-yellow-900/10 hover:from-slate-800 hover:to-yellow-900/20";
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`mb-3 ${accentColor} p-2 bg-slate-950/50 rounded-lg inline-block`}>
                      {icon}
                    </div>
