...
import { JobRole, SkillGroup, EducationItem, Certification, ThoughtLeadershipItem, SocialLink, AwardItem, InterestItem } from './types';
import { 
  Briefcase, 
  Brain, 
  Cloud, 
...
export const SKILLS: SkillGroup[] = [
  {
    ...
    skills: ["Complex Deal Closure ($250M+)", "C-Suite Partnerships", "Digital Transformation", "Cross-functional Team Leadership"]
  },
  {
    category: "Artificial Intelligence",
    icon: <Brain className="w-5 h-5" />,
    skills: ["Generative AI Strategy", "Agentic AI & Copilots", "Prompt Engineering", "AI Business Integration"]
  },
  {
    category: "Cloud & Tech",
    icon: <Cloud className="w-5 h-5" />,
    skills: ["Azure Cloud Strategy", "Solutions Architecture", "Enterprise SaaS", "Data & Security Compliance"]
  },
  {
    category: "Sales Mastery",
    icon: <TrendingUp className="w-5 h-5" />,
    skills: ["Value Negotiation", "Strategic Account Planning", "Go-to-Market Strategy", "Insight Selling"]
  }
];
...
export const AWARDS: AwardItem[] = [
  {
    ...
    description: "Honored twice for exceptional performance, awarded to the top tier of achievers worldwide.",
    color: "platinum"
  },
  {
    ...
    description: "Awarded for outstanding contribution to revenue growth and strategic customer impact.",
    color: "gold"
  },
  {
    ...
    description: "Architected and closed complex multi-year strategic partnerships exceeding $250M in value.",
    color: "blue"
  }
];
...
export const THOUGHT_LEADERSHIP: ThoughtLeadershipItem[] = [
  {
    ...
    description: "Author of a specialized digest dedicated to leveraging Generative AI for smarter stock market investing. Exploring the intersection of financial analysis and agentic workflows.",
    // Link removed until a valid URL is available
  },
  {
    title: "AI in Healthcare",
    type: "Strategic Focus",
    description: "Driving innovation in Pharma and Life Sciences by implementing secure, scalable AI architectures that accelerate drug discovery and operational efficiency."
  }
];
